...
// function activate_my_laravel_plugin($network_wide) {
//     require_once plugin_dir_path(__FILE__) . 'app/Hooks/Handlers/ActivationHandler.php';
//     $activationHandler = new ActivationHandler(new FluentPlugin\Framework\Foundation\Application);
//     $activationHandler->handle($network_wide);
// }
